...
for key, value in data.items():
    ...
    for base_num in range(10):
        base_station = rx_data[base_num][3]
        # print(base_station)
        tr_cords = torch.tensor(value["tx_coords"]).float()
        # print(tr_cords)
        if base_station == 'cbrssdr1-bes-comp' and power == 1:  # 'cbrssdr1-bes-comp', 'cbrssdr1-honors-comp', ,'cbrssdr1-ustar-comp', 'cbrssdr1-hospital-comp'
