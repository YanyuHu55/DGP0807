...
from _8_6_DGP_parameter_100_15 import train_x, predicted_y
from _8_6_DGP_parameter_100_15 import hidden_layer_inducing_points, last_layer_inducing_points
...
from _8_6_DGP_parameter_100_15 import inducing_num_fix
...
torch.manual_seed(8)
RSS_value = predicted_y.view(predicted_y.size(-1),1)
receiver_position = train_x
train_x = receiver_position[15:, :] # cbrssdr1-honors-comp: 409, 359, 309, 189
train_y = RSS_value[15:, :]
